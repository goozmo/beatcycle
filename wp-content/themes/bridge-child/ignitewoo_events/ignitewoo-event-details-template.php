...
?>
	<?php if ( empty( $data['display_organizer'] ) || 'yes' == $data['display_organizer'] ) { ?>
		...
		<div class="ignitewoo_event_details organizer">

			

				<div class="event_thumbs">
				
					<a  title="<?php the_title() ?>" href="<?php echo the_field('profile_link') ?>">
					<?php the_post_thumbnail( 'thumbnail' ) ?>
						...
						<?php if ( '' != get_the_title( $post->ID ) ) { ?>
							...
							<h3 class="instructor-name" itemprop="name"><?php the_title() ?></h3>
							</a>
					...
					<?php } ?>
						...
						<?php if ( '' != $primary_organizers_meta['_generic_email'][0] ) { ?>
							...
							<span itemprop="email"><?php echo $email_addy ?></span>
						...
						<?php if ( '' != $primary_organizers_meta['_generic_phone'] ) { ?>
								...
								<span itemprop="telephone"><?php echo $primary_organizers_meta['_generic_phone'][0] ?></span>
