<?php
/**
 * Square One Custom Functions
 *
 * @package Square One
 */

/* Adds widgetized sidebar */
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'squareone' ),
		'id'            => 'sidebar',
...
/*********************************
Square One Action Hooks
**********************************/

/* Before the opening #content div */
function squareone_before_opening_content() {
    do_action('squareone_before_opening_content');
}

/* After the opening #content and #row div */
function squareone_after_opening_content() {
    do_action('squareone_after_opening_content');
}

/* After the closing #content div */
function squareone_after_closing_content() {
    do_action('squareone_after_closing_content');
}

/* Within #main div */
function squareone_inside_main() {
    do_action('squareone_inside_main');
}
 ...
 */
class squareone_walker extends Walker_Nav_Menu {
	...
	function __construct( $nav_args = '' ) {
		...
		$this->nav_bar = apply_filters( 'square_nav_args', wp_parse_args( $nav_args, $defaults ) );
	}
