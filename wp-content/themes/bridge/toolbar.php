...
<?php
if (strpos($example_url,'bridge/') || (!strpos($example_url,'bridge2/') && !strpos($example_url,'bridge3/') && !strpos($example_url,'bridge4/') && !strpos($example_url,'bridge5/') && !strpos($example_url,'bridge6/') && !strpos($example_url,'bridge7/'))){
?>
