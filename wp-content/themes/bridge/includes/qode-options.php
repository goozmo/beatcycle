	...
	?>
		...
		<div class="sections">
					...
					<tbody>
						...
						<tr valign="top">
							...
							<td>
								...
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Border Bottom on Title Area Color (px)', 'qode'); ?>
								...
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Margin after title for default template', 'qode'); ?>
            ...
            <tr>
                ...
                <td>
                    <div class="inline" style="width: 700px;">
                        <input type="text" id="vertical_area_background_image" name="qode_options_proya[vertical_area_background_image]" class="vertical_area_background_image" value="" size="70">
                        <input class="upload_button" type="button" value="Upload file">
                    </div>
                </td>
            </tr>
