...
<?php if (!empty($qode_options_proya['border_bottom_title_area_color']) ) { ?>
	.title{
	border-bottom-color:<?php echo $qode_options_proya['header_separator_color'];  ?>;
	}
<?php } ?>
<?php if (!empty($qode_options_proya['margin_after_title']) ) { ?>
...
header.sticky .drop_down .second{
	top: <?php echo $qode_options_proya['header_height_sticky'] + $header_bottom_border_width;  ?>px;
}
<?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['page_subtitle_fontsize']) || !empty($qode_options_proya['page_subtitle_lineheight']) || !empty($qode_options_proya['page_subtitle_fontweight'])) { ?>
	.subtitle{
	<?php if (!empty($qode_options_proya['page_subtitle_fontsize'])) { ?>font-size: <?php echo $qode_options_proya['page_subtitle_fontsize'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['page_subtitle_lineheight'])) { ?>line-height: <?php echo $qode_options_proya['page_subtitle_lineheight'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['page_subtitle_fontweight'])) { ?>font-weight: <?php echo $qode_options_proya['page_subtitle_fontweight'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php } ?>
<?php if (!empty($qode_options_proya['separator_thickness']) || !empty($qode_options_proya['separator_topmargin']) || !empty($qode_options_proya['separator_bottommargin']) || !empty($qode_options_proya['separator_color'])) { ?>
.separator{
<?php if (!empty($qode_options_proya['separator_thickness'])) { ?>	height: <?php echo $qode_options_proya['separator_thickness'];  ?>px; <?php } ?>
<?php if (!empty($qode_options_proya['separator_topmargin'])) { ?>	margin-top: <?php echo $qode_options_proya['separator_topmargin'];  ?>px; <?php } ?>
<?php if (!empty($qode_options_proya['separator_bottommargin'])) { ?>	margin-bottom: <?php echo $qode_options_proya['separator_bottommargin'];  ?>px; <?php } ?>
<?php if (!empty($qode_options_proya['separator_color'])) { ?>	background-color: <?php echo $qode_options_proya['separator_color'];  ?>; <?php } ?>
}
<?php } ?>
<?php if (!empty($qode_options_proya['separator_small_thickness']) || !empty($qode_options_proya['separator_small_topmargin']) || !empty($qode_options_proya['separator_small_bottommargin']) || !empty($qode_options_proya['separator_small_color'])  || !empty($qode_options_proya['separator_small_width'])) { ?>
.separator.small,
.wpb_column>.wpb_wrapper .separator.small
{
	<?php if (!empty($qode_options_proya['separator_small_thickness'])) { ?>	height: <?php echo $qode_options_proya['separator_small_thickness'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['separator_small_topmargin'])) { ?>	margin-top: <?php echo $qode_options_proya['separator_small_topmargin'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['separator_small_bottommargin'])) { ?>	margin-bottom: <?php echo $qode_options_proya['separator_small_bottommargin'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['separator_small_color'])) { ?>	background-color: <?php echo $qode_options_proya['separator_small_color'];  ?>; <?php } ?>
	<?php if (!empty($qode_options_proya['separator_small_width'])) { ?>	width: <?php echo $qode_options_proya['separator_small_width'];  ?>px; <?php } ?>
}
<?php } ?>
...
<?php if (!empty($qode_options_proya['counter_text_color']) ||
	...
	<?php if ($qode_options_proya['counters_text_letterspacing'] !== '') { ?>	letter-spacing: <?php echo $qode_options_proya['counters_text_letterspacing'];  ?>; <?php } ?>
...
<?php } ?>
<?php if (isset($qode_options_proya['side_area_background_color']) && !empty($qode_options_proya['side_area_background_color'])) { ?>
	.side_menu,
	.side_menu #lang_sel,
	.side_menu #lang_sel_click,
	.side_menu #lang_sel ul ul,
	.side_menu #lang_sel_click ul ul{
		background-color:<?php echo $qode_options_proya['side_area_background_color'];  ?>;
	}
<?php } ?>
<?php if (isset($qode_options_proya['side_area_text_color']) && !empty($qode_options_proya['side_area_text_color'])) { ?>
	.side_menu .widget,
	...
	{
		color: <?php echo $qode_options_proya['side_area_text_color'];  ?>;
	}
<?php } ?>
<?php if (isset($qode_options_proya['side_area_title_color']) && !empty($qode_options_proya['side_area_title_color'])) { ?>
	.side_menu .side_menu_title h4,
	.side_menu h5{
		color: <?php echo $qode_options_proya['side_area_title_color'];  ?>;
	}
<?php } ?>
