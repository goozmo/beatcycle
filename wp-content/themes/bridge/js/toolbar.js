...
$j(window).load(function(){
    ...
    if((window.location.href.indexOf("bridge/") > -1 || window.location.href.indexOf("bridge2/") > -1) || (window.location.href.indexOf("bridge3/") == -1  && window.location.href.indexOf("bridge4/") == -1 && window.location.href.indexOf("bridge5/") == -1 && window.location.href.indexOf("bridge6/") == -1 && window.location.href.indexOf("bridge7/") == -1)) {
    ...
    setTimeout(function(){
        if((window.location.href.indexOf("bridge/") > -1) || (window.location.href.indexOf("bridge2/") == -1 && window.location.href.indexOf("bridge3/") == -1  && window.location.href.indexOf("bridge4/") == -1 && window.location.href.indexOf("bridge5/") == -1 && window.location.href.indexOf("bridge6/") == -1 && window.location.href.indexOf("bridge7/") == -1)) {
            $j('#toolbar').animate({marginBottom: "0px"});
        }else{
            $j('#toolbar').animate({marginBottom: -($j('#toolbar').height() - 57)+"px"});
...
//	});
    ...
    $j( window ).resize(function() {
        ...
        if ($j('#toolbar').hasClass('off')){
            $j('#toolbar').css({'margin-bottom': -toolbar_height});
        }
    ...
    $j("#toolbar a.open").click(function(e){
        ...
        if ($j('#toolbar').hasClass('off')){
            $j('#toolbar').stop().animate({'margin-bottom': '0px'});
            $j('#toolbar').removeClass('off');
            $j('#toolbar').addClass('on');
            $j("#toolbar a.open").addClass('opened');
        }
        else{
            $j('#toolbar').stop().animate({'margin-bottom': -toolbar_height});
            $j('#toolbar').removeClass('on');
            $j('#toolbar').addClass('off');
            $j("#toolbar a.open").removeClass('opened');
        }
