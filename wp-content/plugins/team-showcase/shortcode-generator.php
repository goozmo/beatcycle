    ...
    <td width="20%" valign="top"><div class="postbox" style="width:360px;">
      <form id="shortcode_generator" style="padding:20px;">
        ...
        <p>
          ...
          <input name="pagination" type="checkbox" id="pagination" value="true" onChange="tshowcaseshortcodegenerate()">
        ...
        <p>
          ...
          <select id="singleurl" name="singleurl" onChange="tshowcaseshortcodegenerate()">
            ...
            <option value="active_new">Active (Default - New Page)</option>
            <option value="active_custom">Active (Personal URL field)</option>
            <option value="active_custom_new">Active (Personal URL field - New Page)</option>
            <option value="active_user">Active (User URL)</option>
            </select>
