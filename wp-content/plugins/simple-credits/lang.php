	...
	private $translations =  array(
			'Credits' => array(
					...
					'de-DE' => 'Credits'
						...
						'Enable initial amount :' => array(
					'en-US' => 'Enable initial amount :',
					'de-DE' => 'Enable initial amount :'
			),
									'Save' => array(
					'en-US' => 'Save',
					'de-DE' => 'Save'
			...
			'Initial Setup' => array(
					...
					'de-DE' => 'Initial Setup'
						...
						'Please set the initial amount :' => array(
					'en-US' => 'Please set the initial amount :',
					'de-DE' => 'Please set the initial amount :'
			),
