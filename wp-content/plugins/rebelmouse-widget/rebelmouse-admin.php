...
function rebelmouse_register_mysettings() {
    ...
    register_setting( 'rebelmouse-settings-group', 'rebelmouse_hide_also_in_rm' );
    register_setting( 'rebelmouse-settings-group', 'rebelmouse_hide_join_rm' );
}
                        ...
                        <ul>
                            ...
                            <li> 'skip' help you to hide modules (only for <a href="https://www.rebelmouse.com/core/users/pricing/" target="_blank">premium sites</a>)
                                <ul>
                                    ...
                                    <li>
                                    also-on-rm: will hide features users.
                                    </li>
                                    <li>
                                    join-rm: will hide the "join us" and rebelmouse promo.
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<form method="post" action="options.php">
    ...
    switch ( $tab ){
        case 'homepage' : 
            ...
            $rebelmouse_hide_also_in_rm = get_option('rebelmouse_hide_also_in_rm');
            $rebelmouse_hide_join_rm    = get_option('rebelmouse_hide_join_rm');
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <td id="rebelmouse-home-features-controls" <?php if ( $rebelmouse_premium !== "true" ) { ?>class="inactive"<?php }?>>
                        ...
                        <br>
                        <!-- Hide Also on rebelmouse: Checkbox -->
                        <input type="checkbox" value="1" 
                                id="rebelmouse_hide_also_in_rm" 
                                name="rebelmouse_hide_also_in_rm" 
                                <?php if ( $rebelmouse_premium !== "true" ) { ?>disabled="disabled"<?php } ?>
                                <?php echo ( $rebelmouse_hide_also_in_rm ? "checked='checked'" : ""); ?> />
                        <label for="rebelmouse_hide_also_in_rm"><?php _e('Hide Featured Sites', 'framework') ?>.</label>
                        <br>
                        <!-- Hide Join us on rebelmouse: Checkbox -->
                        <input type="checkbox" value="1" 
                                id="rebelmouse_hide_join_rm" 
                                name="rebelmouse_hide_join_rm" 
                                <?php if ( $rebelmouse_premium !== "true" ) { ?>disabled="disabled"<?php } ?>
                                <?php echo ( $rebelmouse_hide_join_rm ? "checked='checked'" : ""); ?> />
                        <label for="rebelmouse_hide_join_rm"><?php _e('Hide Join Us on RebelMouse Promo', 'framework') ?>.</label>
                        <br>
                    </td>
                    <td>
                        <div id="rebelmouse-home-explanation" class="rm-power-site-explanation" <?php if ( $rebelmouse_premium === "true" ) { ?>style="display:none;"<?php }?>>
                            <p>Power your Site to be able to remove the Featured, Following on your embed.</p>
                            <a class="rm-power-site" href="https://www.rebelmouse.com/core/users/pricing/" target="_blank">Power Your Site</a>
                        </div>
                    </td>
                </tr> 
                </table>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <td id="rebelmouse-page-features-controls" class="inactive">
                        ...
                        <!-- Hide Also on rebelmouse: Checkbox -->
                        <input type="checkbox" value="1" 
                                id="rebelmouse_page_hide_also_in_rm" 
                                name="rebelmouse_page_hide_also_in_rm" 
                                disabled="disabled" />
                        <label for="rebelmouse_page_hide_also_in_rm"><?php _e('Hide Featured Sites', 'framework') ?>.</label>
                        <br>
                        <!-- Hide Join us on rebelmouse: Checkbox -->
                        <input type="checkbox" value="1" 
                                id="rebelmouse_page_hide_join_rm" 
                                name="rebelmouse_page_hide_join_rm" 
                                disabled="disabled" />
                        <label for="rebelmouse_page_hide_join_rm"><?php _e('Hide Join Us on RebelMouse Promo', 'framework') ?>.</label>
                        <br>
                    </td>
                    <td>
...
if ( isset($_POST['action']) && $_POST['action'] == 'update' && (isset( $_POST['rebelmouse_noncename'] ) && wp_verify_nonce( $_POST['rebelmouse_noncename'], plugin_basename( __FILE__ ) )) ) {
    ...
    if ( $_POST['submit_button'] === translate( 'Add page' ) ){
        ...
        $rebelmouse_hide_also_in_rm = (!isset($_POST['rebelmouse_page_hide_also_in_rm'])) ? "0": $_POST['rebelmouse_page_hide_also_in_rm'];
        $rebelmouse_hide_join_rm    = (!isset($_POST['rebelmouse_page_hide_join_rm'])) ? "0": $_POST['rebelmouse_page_hide_join_rm'];
        ...
        if ( $rebelmouse_hide_also_in_rm == "1")
              $skip_array[] = "also-on-rm";
        if ( $rebelmouse_hide_join_rm == "1")
              $skip_array[] = "join-rm";
        ...
        $rebelmouse_hide_also_in_rm = (!isset($_POST['rebelmouse_hide_also_in_rm'])) ? "0": $_POST['rebelmouse_hide_also_in_rm'];
        $rebelmouse_hide_join_rm    = (!isset($_POST['rebelmouse_hide_join_rm'])) ? "0": $_POST['rebelmouse_hide_join_rm'];
        ...
        update_option('rebelmouse_hide_also_in_rm', $rebelmouse_hide_also_in_rm);
        update_option('rebelmouse_hide_join_rm', $rebelmouse_hide_join_rm);
